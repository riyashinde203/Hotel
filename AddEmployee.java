...
public class AddEmployee extends JFrame{ //Third Frame
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public AddEmployee(){
            ...
            Passportno.setFont(new Font("Times new roman", Font.PLAIN, 16));
            ...
            Pnrno.setFont(new Font("Times new roman", Font.PLAIN, 16));
            ...
            Phno.setFont(new Font("Times new roman", Font.PLAIN, 16));
                  ...
                  //  int ph = Integer.parseInt(phone);
                    ...
                    try {
                        ...
                        String str = "INSERT INTO employee values( '"+name+"', '"+age+"', '"+gender+"','"+s6+"', '"+salary+"', '"+phone+"','"+aadhar+"', '"+email+"')";
                         ...
                         if((phone.matches("\\d{10}")) && (aadhar.matches("\\d{12}")) && (email.matches("[a-z0-9]+@[a-z]+\\.[a-z]{2,3}"))){ 

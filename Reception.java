...
public class Reception extends JFrame {
	...
	public Reception(){
		...
		contentPane.setLayout(null);
                ...
                l1.setBounds(250,80,500,420);
                add(l1);
		
                JLabel AddPassengers = new JLabel("Reception");
            AddPassengers.setForeground(Color.BLACK);
            AddPassengers.setFont(new Font("Times new roman", Font.BOLD, 31));

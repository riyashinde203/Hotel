...
public class Dashboard extends JFrame{
	...
	NewLabel.setBounds(0, 0, 1450, 680); 
        add(NewLabel);
        
        JLabel AirlineManagementSystem = new JLabel("THE TAJ GROUP WELCOMES YOU");
	AirlineManagementSystem.setForeground(Color.BLACK);
        AirlineManagementSystem.setFont(new Font("Times new roman", Font.BOLD, 46));
	AirlineManagementSystem.setBounds(300, 40, 1000, 85);
	...
	setJMenuBar(menuBar);
        ...
        AirlineSystem.setFont(new Font("Times new roman", Font.BOLD, 14));
	...
	JMenu AirlineSystemHello = new JMenu("ADMIN");
        AirlineSystemHello.setFont(new Font("Times new roman", Font.BOLD, 14));
